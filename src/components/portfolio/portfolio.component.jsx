    ...
    const startProject = async () => {
      ...
      try {
        const data = await axios.get(
          `${DB_BASE_URL}/devProject/getDevProjects`
        );
  ...
  return (
    <section id="portfolio" className="portfolio">
      ...
      <ul className="portfolio__categoryContainer">
        <li
          className={`portfolio__categoryContainer-item ${
            activeProject["active"] === "webDevelopment" ? "active" : ""
          }`}
          name="webDevelopment"
        ...
        <li
          className={`portfolio__categoryContainer-item ${
            activeProject["active"] === "machineLearning" ? "active" : ""
          }`}
        ...
        <li
          className={`portfolio__categoryContainer-item ${
            activeProject["active"] === "backEnd" ? "active" : ""
          }`}
          name="backEnd"
          onClick={handleProjectClick}
        >
        ...
        <li
          className={`portfolio__categoryContainer-item ${
            activeProject["active"] === "python" ? "active" : ""
          }`}
          name="python"
          onClick={handleProjectClick}
        >
        ...
        <li
          className={`portfolio__categoryContainer-item ${
            activeProject["active"] === "all" ? "active" : ""
          }`}
          name="all"
          onClick={handleProjectClick}
        >
